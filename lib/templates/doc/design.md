...
Use this file to provide visual resources, mockups, or layout assets for the agent to ingest.

---

## 1. Visual References & Figma Assets
...
- **Accents**: [e.g. Neon Cyan border glows and button backgrounds]
- **Layout Spacing**: [e.g. Compact margins, wide grid gutters]
